...
public class BrassChunkLoaderScenes {
    ...
    public static void loadingContraptions(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        ...
        scene.overlay().showOutlineWithText(trainLoader, 60)
                .attachKeyFrame()
        ...
        scene.overlay().showOutlineWithText(cartLoader, 80)
    ...
    public static void attachStation(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
